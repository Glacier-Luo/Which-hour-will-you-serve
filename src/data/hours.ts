...
export const HOURS_DATA: Hour[] = [
  ...
  },
  {
    ...
    origin: '虚源',
    aspects: ['Heart', 'Grail', 'Moth', 'Lantern', 'Forge'],
    gender: '阳性',
  ...
  },
  {
    ...
    origin: '石源',
    aspects: ['Lantern', 'Secret Histories'],
    gender: '阳性',
